...
function StatItem({ icon, value, suffix, label, started }) {
  ...
  return (
    <div className="gsap-stat text-center group p-6 rounded-2xl bg-[#FFFCF5] dark:bg-[#111915] border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md transition-all duration-300">
...
const Landing = () => {
  ...
  useEffect(() => {
    ...
    // Stats counter trigger (kept as IntersectionObserver — plays nicely with the rAF counter hook)
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set('.gsap-hero-item', { opacity: 0, y: 30 });
      ...
      // Generic scroll reveal — fade + up + slight scale
      ...
      // Stronger scale-in reveal (roadmap cards)
      gsap.utils.toArray('.gsap-scale-group').forEach((group) => {
        const cards = group.querySelectorAll('.gsap-scale-card');
        gsap.fromTo(cards,
      ...
      // Pricing cards stagger + scale
      gsap.fromTo('.gsap-pricing-card',
        { opacity: 0, y: 60, scale: 0.9 },
        {
          opacity: 1, y: 0, scale: 1, duration: 0.75, stagger: 0.15, ease: 'power3.out',
          scrollTrigger: { trigger: '.gsap-pricing-grid', start: 'top 82%', toggleActions: 'play none none reverse' },
        }
      );

      // Progress bars fill on reveal
      gsap.utils.toArray('.gsap-bar').forEach((el) => {
      ...
      gsap.utils.toArray('.gsap-float').forEach((el) => {
        gsap.to(el, { y: -12, duration: 2.6, ease: 'sine.inOut', repeat: -1, yoyo: true });
      });
      ...
      if (chartPathRef.current) {
        ...
        gsap.to(chartPathRef.current, {
          ...
          scrollTrigger: { trigger: chartPathRef.current, start: 'top 85%', toggleActions: 'play none none reverse' },
        });
      }
    }, rootRef);
  ...
  return (
    <div ref={rootRef} className="relative min-h-screen bg-[#F7F1E4] dark:bg-[#0a0f0d] text-[#1E2522] dark:text-gray-200 antialiased"
         style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      <style>{`
        .wise-headline { font-family: 'Plus Jakarta Sans', sans-serif; letter-spacing: -0.02em; }
        @keyframes subtle-pulse { 0%, 100% { transform: scale(1); } 50% { transform: scale(1.03); } }
        .pulse-lime { animation: subtle-pulse 3s infinite ease-in-out; }
      ...
      {/* ══════════ HERO SECTION ══════════ */}
      <section id="hero-section" className="relative bg-[#0a5c48] text-white pt-32 pb-24 px-5 sm:px-8 overflow-hidden">
        <div ref={blob1Ref} className="absolute right-0 top-0 w-[45%] h-full bg-[#084d3c] opacity-65 rounded-l-[150px] pointer-events-none" />
        <div ref={blob2Ref} className="absolute -bottom-16 left-12 w-64 h-64 bg-emerald-400 opacity-5 blur-3xl pointer-events-none" />

        <div className="max-w-6xl mx-auto relative z-10 grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">

          {/* Left Column: Heading */}
          <div className="space-y-6">
            <div className="gsap-hero-item inline-flex items-center gap-2 px-3.5 py-1.5 bg-emerald-400/10 border border-emerald-400/30 rounded-full">
            ...
            <h1 className="gsap-hero-item text-4xl sm:text-5xl lg:text-[3.5rem] font-extrabold tracking-tight leading-[1.08] wise-headline text-white">
            ...
            <p className="gsap-hero-item text-base sm:text-lg text-gray-300 leading-relaxed max-w-md">
              {isEnglish
            ...
            {/* Trust highlights */}
            <div className="gsap-hero-item flex flex-wrap gap-4 pt-2">
              {[
            ...
            <div className="gsap-hero-item flex flex-col sm:flex-row gap-3 pt-4">
              {user ? (
                <button
                  onClick={() => navigate('/dashboard')}
      ...
      <section ref={statsRef} className="py-14 px-5 sm:px-8 bg-[#FFFCF5] dark:bg-[#0a0f0d] border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
          <StatItem icon={<FaUsers size={20} />} value={10000} suffix="+" label={isEnglish ? 'Active Users' : 'Người dùng'} started={statsStarted} />
          <StatItem icon={<FaTrophy size={20} />} value={1500} suffix="K+" label={isEnglish ? 'Transactions' : 'Giao dịch đã nhập'} started={statsStarted} />
          <StatItem icon={<FaCheckCircle size={20} />} value={98} suffix="%" label={isEnglish ? 'Satisfaction' : 'Hài lòng'} started={statsStarted} />
          <StatItem icon={<FaStar size={20} />} value={5} suffix="/5" label={isEnglish ? 'App Rating' : 'Đánh giá ứng dụng'} started={statsStarted} />
        </div>
      </section>
      ...
      <section id="features" className="py-20 px-5 sm:px-8 bg-[#FFFCF5] dark:bg-[#0a0f0d]">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="gsap-reveal gsap-float relative">
            ...
            <div className="relative bg-[#0a5c48] rounded-3xl p-5 text-white shadow-2xl border border-emerald-900">
              ...
              <div className="bg-[#0f241c] rounded-xl p-4 space-y-3.5">
                ...
                <div className="h-2 w-full rounded-full bg-emerald-950 overflow-hidden">
                  <div className="gsap-bar h-full rounded-full bg-emerald-400" data-target="72" style={{ width: '0%' }} />
                </div>
                ...
                <div className="h-2 w-full rounded-full bg-emerald-950 overflow-hidden">
                  <div className="gsap-bar h-full rounded-full bg-emerald-400" data-target="30" style={{ width: '0%' }} />
                </div>
              </div>
      ...
      <section className="py-14 px-5 sm:px-8 bg-emerald-400 text-[#0a5c48] text-center relative overflow-hidden">
        ...
        <div className="gsap-reveal max-w-3xl mx-auto space-y-4 relative z-10">
      ...
      <section id="how" className="py-20 px-5 sm:px-8 bg-[#F7F1E4] dark:bg-[#0c1310]">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="gsap-reveal relative flex justify-center order-2 lg:order-1">
              ...
              <div className="flex-1 flex flex-col pt-6 px-1">
                ...
                <div className="bg-[#2d3748] rounded-xl p-3 border border-gray-700/50 space-y-2.5 text-white">
                  ...
                  <div className="h-1.5 w-full bg-gray-700 rounded-full overflow-hidden">
                    <div className="gsap-bar h-full bg-emerald-500 rounded-full" data-target="100" style={{ width: '0%' }} />
                  </div>
                  ...
                  <div className="h-1.5 w-full bg-gray-700 rounded-full overflow-hidden">
                    <div className="gsap-bar h-full bg-emerald-400 rounded-full" data-target="45" style={{ width: '0%' }} />
                  </div>
                </div>
              </div>
          ...
          <div className="gsap-reveal space-y-6 order-1 lg:order-2">
      ...
      <section className="py-20 px-5 sm:px-8 bg-[#FFFCF5] dark:bg-[#0a0f0d] border-t border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="gsap-reveal relative pt-6 bg-[#F3EBD8] dark:bg-[#111915] rounded-3xl p-6 border border-gray-200/50 dark:border-gray-800/85 shadow-sm flex flex-col justify-between min-h-[300px]">
      ...
      <section id="pricing" className="py-20 px-5 sm:px-8 bg-[#F7F1E4] dark:bg-[#0c1310] relative">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="gsap-pricing-grid grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            {plans.map((plan) => (
              <div
                key={plan.id}
                className={`gsap-pricing-card relative rounded-3xl border p-7 flex flex-col justify-between transition-all duration-300 bg-[#FFFCF5] dark:bg-[#111915]
                  ${plan.isPopular
      ...
      <section className="py-24 px-5 sm:px-8 bg-[#0a5c48] text-white border-t border-b border-emerald-950">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="gsap-scale-group grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="gsap-scale-card bg-[#084d3c] dark:bg-[#00261c] border border-emerald-900/60 dark:border-emerald-950/40 rounded-2xl p-5 hover:scale-[1.02] transition-transform duration-200">
      ...
      <section id="faq" className="py-20 px-5 sm:px-8 bg-[#FFFCF5] dark:bg-[#0a0f0d]">
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div className="gsap-reveal text-center space-y-2">
            <span className="text-xs font-bold text-emerald-600 bg-emerald-50 dark:bg-emerald-950/20 px-3 py-1 rounded-full uppercase tracking-widest">
      ...
      <section className="py-20 px-5 sm:px-8 bg-[#0a5c48] text-white text-center relative overflow-hidden">
        ...
        <div className="gsap-reveal max-w-2xl mx-auto space-y-6 relative z-10">
